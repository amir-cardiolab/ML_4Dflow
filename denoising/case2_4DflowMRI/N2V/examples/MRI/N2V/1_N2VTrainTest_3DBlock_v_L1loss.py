...
velocity_field = 'v'
Xv, mesh = read_velocity_data(input_dir, filename, reader, t_transient, t_end, velocity_field)
# velocity_field = 'w'
...
out_filename = 'batch1/N2V_L1_reconstruction_v'
...
for j in range(0,snapshots):
    meshNew.CellData.append(u_noisy[:,j], 'v')
    meshNew.CellData.append(N2Vrecu[:,j],'N2V_v')
